...
Usage:
    python scripts/run_tests_fast.py           # Run fast unit tests
    python scripts/run_tests_fast.py --all     # Run all tests (same as run_all_tests.py)
    python scripts/run_tests_fast.py --list    # List available test modules
"""
