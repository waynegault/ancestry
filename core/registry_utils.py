...
class SmartFunctionRegistry:
    ...
    def _get_default_include_patterns(self) -> list[str]:
        """Get default include patterns for function registration."""
        return [
    ...
    def _get_default_exclude_patterns(self) -> list[str]:
        """Get default exclude patterns for function registration."""
        return [
            "_private",
            "__",
            "_internal",
    ...
    def _should_register_function(self, name: str, obj: Any, include_patterns: list[str], exclude_patterns: list[str]) -> bool:
        """Determine if a function should be registered based on patterns."""
    ...
    def register_module(
        ...
        for name, obj in module_globals.items():
            if self._should_register_function(name, obj, include_patterns, exclude_patterns):
                try:
