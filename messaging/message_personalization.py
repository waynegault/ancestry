...
class MessagePersonalizer:
    ...
    def _build_personalization_registry(self) -> dict[str, Callable[[dict[str, Any]], str]]:
        ...
        return {
            ...
            "record_sharing_context": self._create_record_sharing_context,
    ...
    @staticmethod
    def _create_record_sharing_context(extracted_data: dict[str, Any]) -> str:
        """Create record sharing context based on extracted data."""
        records = extracted_data.get("records", [])
        if not records:
            return ""

        # Get person name from extracted data
        person_name = "your ancestor"
        ...
        return format_multiple_records(person_name, records)
