...
# Shared matches between owner and match (uses relationguid param)
API_PATH_SHARED_MATCHES = "discoveryui-matchesservice/api/samples/{my_uuid}/matches/list"
...
def api_constants_module_tests() -> bool:
    ...
    critical_tests = [
        ...
        (
            ...
            "discoveryui-matchesservice/api/samples/{my_uuid}/matches/list",
        ),
        ("API_PATH_TREESUI_LIST", "api/treesui-list/trees/{tree_id}/persons"),
        ("API_PATH_HEADER_TREES", "api/treesui-list/trees?rights=own"),
    ]
    ...
    literal_tests = [
        ...
        "discoveryui-matchesservice/api/samples/",
