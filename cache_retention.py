...
class CacheRetentionService:
    ...
    def apply_policies(self, target_name: Optional[str] = None, *, auto_triggered: bool = False) -> dict[str, RetentionResult]:
    ...
    def _scan_files(target: RetentionTarget) -> list[FileInfo]:
        ...
        extensions = {ext.lower() if ext.startswith(".") else f".{ext.lower()}" for ext in target.policy.file_extensions}
