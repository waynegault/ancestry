...
def test_api_endpoints():
    ...
    test_cases = [
        # Test 1: Base URL format as provided
        {
            "description": "Base URL format as provided",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES"},
        },
        # Test 2: Add birth year parameter (by)
        {
            "description": "With birth year parameter (by)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES", "by": "1941"},
        },
        # Test 3: Add birth year parameter (birthYear)
        {
            "description": "With birth year parameter (birthYear)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES", "birthYear": "1941"},
        },
        # Test 4: Add birth year range parameters (bymin, bymax)
        {
            "description": "With birth year range parameters (bymin, bymax)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES", "bymin": "1940", "bymax": "1942"},
        },
        # Test 5: Add birth year range parameters (birthYearFrom, birthYearTo)
        {
            "description": "With birth year range parameters (birthYearFrom, birthYearTo)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES", "birthYearFrom": "1940", "birthYearTo": "1942"},
        },
        # Test 6: Add first name 'fraser' and birth year
        {
            "description": "With first name 'fraser' and birth year",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"fn": "fraser", "ln": "gault", "limit": "100", "fields": "NAMES", "by": "1941"},
        },
        # Test 7: Add first name 'f' (partial) and birth year
        {
            "description": "With partial first name 'f' and birth year",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"fn": "f", "ln": "gault", "limit": "100", "fields": "NAMES", "by": "1941"},
        },
        # Test 8: Try with different fields parameter
        {
            "description": "With different fields parameter (ALL)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "ALL", "by": "1941"},
        },
        # Test 9: Try with different fields parameter (BIRTH_DEATH)
        {
            "description": "With different fields parameter (BIRTH_DEATH)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "BIRTH_DEATH", "by": "1941"},
        },
        # Test 10: Try with different fields parameter (NAMES,BIRTH_DEATH)
        {
            "description": "With different fields parameter (NAMES,BIRTH_DEATH)",
            "url": f"{base_url}/api/treesui-list/trees/{tree_id}/persons",
            "params": {"ln": "gault", "limit": "100", "fields": "NAMES,BIRTH_DEATH", "by": "1941"},
        },
    ]
    ...
    for i, test_case in enumerate(test_cases):
        ...
        try:
            ...
            try:
                ...
                filename = f"test5_response_{i+1}.json"
