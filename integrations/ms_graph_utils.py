...
from testing.test_framework import MagicMock, TestSuite, patch, suppress_logging
...
run_comprehensive_tests = create_standard_test_runner(ms_graph_utils_module_tests)
