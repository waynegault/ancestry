...
Action 10 (GEDCOM) and Action 11 (API) modules. Consolidates duplicate
scoring logic and ensures consistent scoring algorithms.
...
def format_scoring_breakdown(
    result: dict[str, Any], _search_criteria: dict[str, Any], title: str = "Scoring Breakdown"
) -> str:
    """
...
def _test_universal_scoring_basic() -> None:
    ...
    candidates = [{"id": "@I1@", "first_name": "john", "surname": "smith", "birth_year": 1950, "gender": "m"}]

    search_criteria = {"first_name": "john", "surname": "smith", "birth_year": 1950}
...
def _test_universal_scoring_partial_match() -> None:
    ...
    candidates = [{"id": "@I1@", "first_name": "john", "surname": "smith", "birth_year": None, "gender": None}]

    search_criteria = {"first_name": "john", "surname": "smith", "birth_year": 1950, "gender": "m"}
...
def _test_universal_scoring_no_match() -> None:
    ...
    candidates = [{"id": "@I1@", "first_name": "jane", "surname": "doe", "birth_year": 1980, "gender": "f"}]
...
def _test_universal_scoring_multiple_candidates() -> None:
    ...
    candidates = [
        {"id": "@I1@", "first_name": "john", "surname": "smith", "birth_year": 1950, "gender": "m"},
        {"id": "@I2@", "first_name": "john", "surname": "smith", "birth_year": 1951, "gender": "m"},
        {"id": "@I3@", "first_name": "jane", "surname": "smith", "birth_year": 1950, "gender": "f"},
    ]
...
def _test_criteria_validation_years() -> None:
    ...
    criteria = {"birth_year": "1950", "death_year": "2020"}
...
def _test_criteria_validation_gender() -> None:
    ...
    test_cases = [("Male", "m"), ("m", "m"), ("man", "m"), ("Female", "f"), ("f", "f"), ("woman", "f")]

    for input_gender, expected_gender in test_cases:
        criteria = {"gender": input_gender}
        normalized = validate_search_criteria(criteria)
        assert normalized['gender'] == expected_gender, (
            f"Gender '{input_gender}' should normalize to '{expected_gender}'"
        )


def _test_criteria_validation_invalid_year() -> None:
    """Test search criteria validation with invalid year."""
    criteria = {"birth_year": "invalid", "death_year": "not_a_number"}
...
def _test_display_bonuses_action10_format() -> None:
    ...
    scores = {"byear_s": 25, "bplace_s": 25, "dyear_s": 25, "dplace_s": 25}
...
def _test_display_bonuses_action11_format() -> None:
    ...
    scores = {"byear": 25, "bplace": 25, "dyear": 0, "dplace": 0}
...
def _test_scoring_breakdown_format() -> None:
    ...
    result = {
        'total_score': 150,
        'field_scores': {'givn': 25, 'surn': 25, 'byear': 25, 'bplace': 25, 'gender': 25, 'bbonus': 25},
    ...
    assert "First name exact match" in breakdown or "First Name Match" in breakdown, (
        "Breakdown should include field scores or reasons"
    )
