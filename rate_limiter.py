...
_persisted_state_cache: dict[str, Any] | None = None
...
class AdaptiveRateLimiter:
    ...
    def _apply_endpoint_throttle(self, endpoint: str | None, base_wait: float) -> float:
    ...
    def configure_endpoint_profiles(self, profiles: dict[str, Any] | None) -> None:
