...
class IntelligentResearchPrioritizer:
    ...
    def _generate_priority_tasks_from_dna(self, dna_crossref_analysis: dict[str, Any]):
        ...
        for opportunity in verification_opportunities:
            ...
            priority = ResearchPriority(
                ...
                priority_score=priority_score,
                urgency="high",
                research_context={"opportunity_type": opportunity.get("type"), "dna_evidence": True},
    ...
    def _map_severity_to_urgency(severity: str) -> str:
        ...
        mapping = {"critical": "critical", "major": "high", "minor": "medium"}
...
def test_research_prioritization() -> bool:
    ...
    mock_gedcom_analysis = {
        ...
        "ai_insights": {"family_patterns": {"common_surnames": ["Smith", "Jones"]}},
    }
        ...
        "gaps_identified": [
            {
                ...
                "person_name": "John Smith",
                "gap_type": "missing_parents",
                "description": "Missing parents",
                "priority": "high",
                "research_suggestions": [],
            },
            {
                "person_id": "I2",
                "person_name": "Ann Smith",
        ...
        gaps.append(
            {
                ...
                "description": f"Missing birth location Scotland for Person{i}",
                "priority": "medium",
                "research_suggestions": [],
            }
        )
        ...
        "research_opportunities": [
            {
                ...
                "description": "Migration research Scotland",
                "target_people": [],
            }
        ],
